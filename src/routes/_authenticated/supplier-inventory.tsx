...
const demoItems: SupplierInventoryItem[] = [
  {
    id: "SI-001",
    supplier: "المورد الصناعي السعودي",
    productName: "خزانة معدنية 4 أدراج",
    sku: "MET-CAB-4D-001",
    availableQty: 120,
    reservedQty: 30,
    unitPrice: 850,
  ...
  },
  {
    id: "SI-002",
    supplier: "المورد الصناعي السعودي",
    productName: "رف تخزين ثقيل 3 أمتار",
    sku: "RCK-HVY-3M-002",
    availableQty: 45,
    reservedQty: 15,
    unitPrice: 1200,
  ...
  {
    id: "SI-003",
    supplier: "تقنية الأثاث المكتبي",
    productName: "مكتب إداري خشبي",
    sku: "DSK-EXE-WD-003",
    availableQty: 0,
    reservedQty: 0,
    unitPrice: 2100,
  ...
  {
    id: "SI-004",
    supplier: "الحديد والصلب المتحدة",
    productName: "قاعدة معدنية قابلة للتعديل",
    sku: "BAS-ADJ-MT-004",
    availableQty: 300,
    reservedQty: 50,
    unitPrice: 180,
            ...
            <TableBody>
              {items.map((item) => (
                <TableRow key={item.id}>
                  ...
                  <TableCell className="text-center text-muted-foreground num">
                    {item.reservedQty}
                  </TableCell>
